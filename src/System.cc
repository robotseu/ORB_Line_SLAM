...
{
    cout << endl << "ORB_Line_SLAM based on ORB-SLAM2, Lab404, School of Automation, Southeast University." << endl;
    ...
    mpLoopCloser = new LoopClosing(mpMap, mpKeyFrameDatabase, mpVocabulary, mpVocabulary_l, mSensor!=MONOCULAR);
